 ...
 */
#ifndef _ZEPHYR_POLLING_BLUETOOTH_BLUETOOTH_H_
#define _ZEPHYR_POLLING_BLUETOOTH_BLUETOOTH_H_
...
#define BT_LE_ADV_CONN_DIR(_peer)                                                                  \
    BT_LE_ADV_PARAM(BT_LE_ADV_OPT_CONNECTABLE | BT_LE_ADV_OPT_ONE_TIME, 0, 0, _peer)
...
#define BT_LE_ADV_CONN_NAME                                                                        \
    BT_LE_ADV_PARAM(BT_LE_ADV_OPT_CONNECTABLE | BT_LE_ADV_OPT_USE_NAME, BT_GAP_ADV_FAST_INT_MIN_2, \
                    BT_GAP_ADV_FAST_INT_MAX_2, NULL)
...
#define BT_LE_ADV_NCONN_NAME                                                                       \
    BT_LE_ADV_PARAM(BT_LE_ADV_OPT_USE_NAME, BT_GAP_ADV_FAST_INT_MIN_2, BT_GAP_ADV_FAST_INT_MAX_2,  \
                    NULL)
...
#define BT_LE_EXT_ADV_NCONN                                                                        \
    BT_LE_ADV_PARAM(BT_LE_ADV_OPT_EXT_ADV, BT_GAP_ADV_FAST_INT_MIN_2, BT_GAP_ADV_FAST_INT_MAX_2,   \
                    NULL)
...
#define BT_LE_EXT_ADV_NCONN_IDENTITY                                                               \
    BT_LE_ADV_PARAM(BT_LE_ADV_OPT_EXT_ADV | BT_LE_ADV_OPT_USE_IDENTITY, BT_GAP_ADV_FAST_INT_MIN_2, \
                    BT_GAP_ADV_FAST_INT_MAX_2, NULL)
...
#define BT_LE_EXT_ADV_START_PARAM(_timeout, _n_evts)                                               \
    ((struct bt_le_ext_adv_start_param[]){BT_LE_EXT_ADV_START_PARAM_INIT((_timeout), (_n_evts))})
...
struct bt_le_per_adv_sync_cb
{
     ...
     */
    void (*recv)(struct bt_le_per_adv_sync *sync, const struct bt_le_per_adv_sync_recv_info *info,
                 struct net_buf_simple *buf);
...
#define BT_LE_SCAN_PARAM_INIT(_type, _options, _interval, _window)                                 \
    {                                                                                              \
        .type = (_type), .options = (_options), .interval = (_interval), .window = (_window),      \
        .timeout = 0, .interval_coded = 0, .window_coded = 0,                                      \
    }
...
__deprecated static inline int bt_le_whitelist_add(const bt_addr_le_t *addr)
{
...
__deprecated static inline int bt_le_whitelist_rem(const bt_addr_le_t *addr)
{
...
__deprecated static inline int bt_le_whitelist_clear(void)
{
...
#endif /* _ZEPHYR_POLLING_BLUETOOTH_BLUETOOTH_H_ */