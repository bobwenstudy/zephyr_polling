 ...
 */
#ifndef _ZEPHYR_POLLING_BLUETOOTH_CONN_H_
#define _ZEPHYR_POLLING_BLUETOOTH_CONN_H_
...
#define BT_CONN_CB_DEFINE(_name)                                                                   \
    static const STRUCT_SECTION_ITERABLE(bt_conn_cb, _CONCAT(bt_conn_cb_, _name))
...
#endif /* _ZEPHYR_POLLING_BLUETOOTH_CONN_H_ */