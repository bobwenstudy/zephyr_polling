 ...
 */
#ifndef _ZEPHYR_POLLING_BLUETOOTH_CRYPTO_H_
#define _ZEPHYR_POLLING_BLUETOOTH_CRYPTO_H_
 ...
 *  @retval -EINVAL  Invalid parameters.
 */
int bt_ccm_encrypt(const uint8_t key[16], uint8_t nonce[13], const uint8_t *enc_data, size_t len,
                   const uint8_t *aad, size_t aad_len, uint8_t *plaintext, size_t mic_size);
...
#endif /* _ZEPHYR_POLLING_BLUETOOTH_CRYPTO_H_ */