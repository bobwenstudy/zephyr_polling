...
static uint8_t generate_keys(void)
{
    do
    {
        ...
        rc = uECC_make_key(ecc.public_key_be, ecc.private_key_be, &curve_secp256r1);
...
static void emulate_le_p256_public_key_cmd(void)
{
    ...
    else
    {
        ...
        sys_memcpy_swap(&evt->key[BT_PUB_KEY_COORD_LEN], &ecc.public_key_be[BT_PUB_KEY_COORD_LEN],
