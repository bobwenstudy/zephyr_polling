...
#ifndef _ZEPHYR_POLLING_HOST_L2CAP_INTERNAL_H_
#define _ZEPHYR_POLLING_HOST_L2CAP_INTERNAL_H_
...
#define BT_L2CAP_CHANNEL_DEFINE_NEW(_name, _cid, _accept, _destroy)                                \
...
static inline int bt_l2cap_send(struct bt_conn *conn, uint16_t cid, struct net_buf *buf)
{
