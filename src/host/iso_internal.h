...
#ifndef _ZEPHYR_POLLING_ISO_INTERNAL_H_
#define _ZEPHYR_POLLING_ISO_INTERNAL_H_
...
#define bt_iso_create_pdu_timeout(_pool, _reserve, _timeout)                                       \
    bt_iso_create_pdu_timeout_debug(_pool, _reserve, _timeout, __func__, __LINE__)

#define bt_iso_create_pdu(_pool, _reserve)                                                         \
    bt_iso_create_pdu_timeout_debug(_pool, _reserve, K_FOREVER, __func__, __line__)
#else
struct net_buf *bt_iso_create_pdu_timeout(struct net_buf_pool *pool, size_t reserve,
                                          k_timeout_t timeout);

#define bt_iso_create_pdu(_pool, _reserve) bt_iso_create_pdu_timeout(_pool, _reserve, K_FOREVER)
#endif
...
#define bt_iso_create_frag(_reserve)                                                               \
    bt_iso_create_frag_timeout_debug(_reserve, K_FOREVER, __func__, __LINE__)
#else
...
#endif /* _ZEPHYR_POLLING_ISO_INTERNAL_H_ */