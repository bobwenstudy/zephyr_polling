...
#ifndef _ZEPHYR_POLLING_BASE_UTIL_INTERNAL_H_
#define _ZEPHYR_POLLING_BASE_UTIL_INTERNAL_H_
...
#define UTIL_REPEAT(count, macro, ...)                                                             \
    UTIL_WHEN(count)                                                                               \
    (UTIL_OBSTRUCT(UTIL_REPEAT_INDIRECT)()(UTIL_DEC(count), macro, __VA_ARGS__)UTIL_OBSTRUCT(      \
            macro)(UTIL_DEC(count), __VA_ARGS__))
...
#define Z_FOR_EACH_IDX(count, n, macro, sep, fixed_arg0, fixed_arg1, ...)                          \
    UTIL_WHEN(count)                                                                               \
    (UTIL_OBSTRUCT(macro)(fixed_arg0, fixed_arg1, n, Z_GET_ARG1(__VA_ARGS__))                      \
             COND_CODE_1(count, (), (__DEBRACKET sep)) UTIL_OBSTRUCT(Z_FOR_EACH_IDX_INDIRECT)()(   \
                     UTIL_DEC(count), UTIL_INC(n), macro, sep, fixed_arg0, fixed_arg1,             \
...
#define Z_FOR_EACH_IDX2(count, iter, macro, sc, fixed_arg0, fixed_arg1, ...)                       \
    UTIL_EVAL(Z_FOR_EACH_IDX (count, iter, macro, sc, fixed_arg0, fixed_arg1, __VA_ARGS__))

#define Z_FOR_EACH_SWALLOW_NOTHING(F, fixed_arg, index, arg) F(index, arg, fixed_arg)
 ...
 */
#define Z_GET_ARG_N_EVAL(...)  Z_GET_ARG_N_EVAL1(Z_GET_ARG_N_EVAL1(Z_GET_ARG_N_EVAL1(__VA_ARGS__)))
#define Z_GET_ARG_N_EVAL1(...) Z_GET_ARG_N_EVAL2(Z_GET_ARG_N_EVAL2(Z_GET_ARG_N_EVAL2(__VA_ARGS__)))
#define Z_GET_ARG_N_EVAL2(...) Z_GET_ARG_N_EVAL3(Z_GET_ARG_N_EVAL3(Z_GET_ARG_N_EVAL3(__VA_ARGS__)))
#define Z_GET_ARG_N_EVAL3(...) Z_GET_ARG_N_EVAL4(Z_GET_ARG_N_EVAL4(Z_GET_ARG_N_EVAL4(__VA_ARGS__)))
#define Z_GET_ARG_N_EVAL4(...) Z_GET_ARG_N_EVAL5(Z_GET_ARG_N_EVAL5(Z_GET_ARG_N_EVAL5(__VA_ARGS__)))
...
#define Z_GET_ARG_N(count, single_arg, ...)                                                        \
    ...
    (IF_ENABLED(count, (UTIL_OBSTRUCT(__DEBRACKET)(COND_CODE_1(                                    \
                               single_arg, (Z_GET_ARG1(__VA_ARGS__)), (__VA_ARGS__)))))            \
             UTIL_OBSTRUCT(Z_GET_ARG_N_INDIRECT)()(UTIL_DEC(count), single_arg,                    \
                                                   Z_GET_ARGS_LESS_1(__VA_ARGS__)))

#define Z_GET_ARG_N_INDIRECT() Z_GET_ARG_N

#define _Z_GET_ARG_N(N, single_arg, ...) Z_GET_ARG_N_EVAL(Z_GET_ARG_N(N, single_arg, __VA_ARGS__))

/* Implementation details for NUM_VA_ARGS_LESS_1 */
#define NUM_VA_ARGS_LESS_1_IMPL(_ignored, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12,   \
                                ...
                                _52, _53, _54, _55, _56, _57, _58, _59, _60, _61, _62, N, ...)     \
    N
...
#endif /* _ZEPHYR_POLLING_BASE_UTIL_INTERNAL_H_ */