...
#ifndef _ZEPHYR_POLLING_BASE_ATOMIC_H_
#define _ZEPHYR_POLLING_BASE_ATOMIC_H_
...
{
    return __atomic_compare_exchange_n(target, &old_value, new_value, 0, __ATOMIC_SEQ_CST,
                                       __ATOMIC_SEQ_CST);
}
#elif defined(CONFIG_ATOMIC_OPERATIONS_C)
__syscall bool atomic_cas(atomic_t *target, atomic_val_t old_value, atomic_val_t new_value);
...
#endif /* _ZEPHYR_POLLING_BASE_ATOMIC_H_ */