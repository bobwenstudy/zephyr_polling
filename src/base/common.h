...
#ifndef _ZEPHYR_POLLING_BASE_COMMON_H_
#define _ZEPHYR_POLLING_BASE_COMMON_H_
...
#define Z_STRUCT_SECTION_LIST_VAR_INITIAL(struct_type)                                             \
    ...
    *_CONCAT(_##struct_type, _list_end) =                                                          \
            (_CONCAT(_##struct_type, _list)[sizeof(_CONCAT(_##struct_type, _list))]);

#endif

#endif /* _ZEPHYR_POLLING_BASE_COMMON_H_ */