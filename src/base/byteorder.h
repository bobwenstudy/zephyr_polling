...
#ifndef _ZEPHYR_POLLING_BASE_BYTEORDER_H_
#define _ZEPHYR_POLLING_BASE_BYTEORDER_H_
...
static inline void sys_memcpy_swap(void *dst, const void *src, size_t length)
{
    ...
    __ASSERT(((psrc < pdst && (psrc + length) <= pdst) || (psrc > pdst && (pdst + length) <= psrc)),
...
#endif /* _ZEPHYR_POLLING_BASE_BYTEORDER_H_ */